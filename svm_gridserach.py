...
@@ -20,13 +36,54 @@ def img2vector(file_path):
    return vec
...
@@ -40,6 +97,23 @@ def load_dataset(dir_path):
...
# ========== 3. 指定你的训练集 / 测试集目录 ==========
@@ -57,7 +131,6 @@ def load_dataset(dir_path):
"""
【任务 1】：
    ...
    1. 先创建一个 SVC 模型，比如：
           svc = SVC(kernel="rbf")
@@ -92,7 +165,6 @@ def load_dataset(dir_path):
"""
【任务 2】：
...
@@ -113,3 +185,85 @@ def load_dataset(dir_path):
# test_acc = ...
